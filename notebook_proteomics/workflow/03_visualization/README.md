...
| [Heatmaps](#heatmaps) | `{{ heatmaps_generated }}` | p-value heatmaps were generated for the enabled comparisons that retained p-value-significant proteins |
...
⬜ q-value heatmaps were correctly absent or otherwise handled as expected for the current run  
